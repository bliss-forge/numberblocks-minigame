...
[![테스트](https://img.shields.io/badge/테스트-775개-7BC67B?style=flat-square)](#테스트)
[![의존성](https://img.shields.io/badge/의존성-0-F2A65A?style=flat-square)](#어떻게-만들어졌나)
[![음성](https://img.shields.io/badge/한국어·영어_음성-680개-C79BE0?style=flat-square)](#소리와-음성)
...
| 종류 | 내용 |
| --- | --- |
| 안내 음성 | 한국어 345개 · 영어 335개 (`assets/audio/voice/`) |
...
반응형 스타일, 음성 자산 존재 여부까지 **775개**가 확인합니다.
